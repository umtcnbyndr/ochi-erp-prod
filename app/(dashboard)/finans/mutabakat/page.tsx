...
export default async function MutabakatPage() {
  ...
  // Mutabakatlı aylar (son 6 ay özet için)
  const months = await prisma.trendyolOrderReconciliation.groupBy({
    by: ["month"],
    _count: { _all: true },
    ...
    <div className="space-y-4">
      ...
      <Tabs defaultValue="trendyol">
        <TabsList>
          ...
          <TabsTrigger value="pazarama" disabled>
            Pazarama <Badge variant="outline" className="ml-1 text-[9px]">Yakında</Badge>
          </TabsTrigger>
        </TabsList>
