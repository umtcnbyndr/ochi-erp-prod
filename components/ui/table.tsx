...
>(({ className, ...props }, ref) => (
  ...
  <thead
    ref={ref}
    className={cn(
      "[&_tr]:border-b bg-muted sticky top-0 z-10 shadow-[0_1px_0_0_hsl(var(--border))]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "h-8 px-1 text-left align-middle text-[11px] font-semibold uppercase tracking-wide text-muted-foreground [&:has([role=checkbox])]:pr-0",
      className
    )}
    {...props}
  />
